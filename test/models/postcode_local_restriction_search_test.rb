...
describe PostcodeLocalRestrictionSearch do
  ...
  describe "#postcode" do
    it "returns the input as a formatted UK postcode when it's valid" do
      instance = described_class.new("e18qs")
      assert_equal "E1 8QS", instance.postcode
    end
  ...
  describe "#invalid_postcode?" do
    ...
    it "returns false when the input is an invalid postcode" do
      assert_not described_class.new("E1 8QS").invalid_postcode?
    end
  end

  describe "#local_restriction" do
    it "matches the location known in our local restrictions library" do
