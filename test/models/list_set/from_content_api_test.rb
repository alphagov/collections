...
describe ListSet::FromContentAPI do
  describe "for a curated subtopic" do
    setup do
      ...
      @list_set = ListSet::FromContentAPI.new("section", "business-tax/paye", @group_data)
    end
  ...
  describe "for a non-curated topic" do
    setup do
      ...
      @list_set = ListSet::FromContentAPI.new("section", "business-tax/paye", [])
    end
    ...
    it "handles nil data the same as empty array" do
      @list_set = ListSet::FromContentAPI.new("section", "business-tax/paye", nil)
      assert_equal 1, @list_set.to_a.size
      assert_equal "A to Z", @list_set.first.title
    end
  end
