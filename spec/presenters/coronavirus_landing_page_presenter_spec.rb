RSpec.describe CoronavirusLandingPagePresenter do
        ...
        [
          ...
          [
            ...
            },
            {
              ...
              "tags" => "<strong class='govuk-tag govuk-tag--blue'>England</strong>",
            },
            {
        ...
        [
          ...
          [
            ...
            },
            {
              ...
              "tags" => "<strong class='govuk-tag govuk-tag--blue'>Northern Ireland</strong>",
            },
          ],
        ],
        [
          ...
          [
            ...
            },
            {
              ...
              "tags" => "<strong class='govuk-tag govuk-tag--blue'>Scotland</strong>",
            },
          ],
        ],
        [
  ...
  describe "#timeline_nations_items" do
    ...
    it "sets england to selected if selected country is not in the uk" do
      presenter = described_class.new(coronavirus_content_item_with_timeline_national_applicability, "foo")

      expect(presenter.timeline_nations_items).to eq(expected)
    end

    it "sets selected county to selected if selected country is in the uk" do
      presenter = described_class.new(coronavirus_content_item_with_timeline_national_applicability, "wales")
