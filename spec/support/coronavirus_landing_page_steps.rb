...
module CoronavirusLandingPageSteps
  ...
  def then_i_can_see_the_timeline_for_england
    expect(page).to have_content(I18n.t("coronavirus_landing_page.show.timeline.controls.status_html", nation: "England"))
  ...
  def then_i_can_see_the_timeline_for_wales
    expect(page).to have_content(I18n.t("coronavirus_landing_page.show.timeline.controls.status_html", nation: "Wales"))
