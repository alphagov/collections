Rails.application.routes.draw do
  ...
  get '/brexit', to: 'brexit_landing_page#show' if Rails.application.config.respond_to?(:show_brexit_landing_page) && Rails.application.config.show_brexit_landing_page
