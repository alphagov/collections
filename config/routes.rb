Rails.application.routes.draw do
  ...
  get "/cost-of-living", to: "cost_of_living_landing_page#show", as: :cost_of_living_landing_page if Rails.application.config.respond_to?(:show_cost_of_living_landing_page) && Rails.application.config.show_cost_of_living_landing_page
